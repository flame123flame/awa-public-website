  ...
  employeeTestimonials = [
    {
      ...
      duration: '2 ปี',
      avatar: '👨‍💻',
      comment: 'AWA เป็นที่ทำงานที่ดีมาก ได้เรียนรู้เทคโนโลยีใหม่ๆ ตลอดเวลา และทีมงานช่วยเหลือกันดี',
      rating: 5
    },
    {
      name: 'นภาพร ดีไซน์',
      ...
      duration: '1.5 ปี',
      avatar: '👩‍🎨',
      comment: 'ที่นี่ให้อิสระในการสร้างสรรค์และมีโอกาสทำงานกับโปรเจคที่หลากหลาย Work-life balance ดีมาก',
      rating: 5
    },
    {
      name: 'วิชัย เทสต์เก่ง',
      position: 'QA Engineer',
      duration: '3 ปี',
      avatar: '👨‍🔬',
      comment: 'บริษัทใส่ใจในคุณภาพของซอฟต์แวร์จริงๆ และสนับสนุนให้พนักงานพัฒนาทักษะอย่างต่อเนื่อง',
      rating: 5
    }
  ];
